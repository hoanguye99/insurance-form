...
import { selectPaymentMethods, selectStatus } from 'features/payment/payment-methods-slice'
import { PaymentMethodsType, PaymentTokensType } from 'models/api'
import React, { useState } from 'react'
import { UseFormRegister, UseFormWatch } from 'react-hook-form'
import { PaymentMethodsFormData } from '.'
  ...
  return (
    <div className="shadow overflow-hidden sm:rounded-md">
      <div className="px-4 py-5 bg-white sm:p-6">
        ...
        {paymentMethodsStatus === 'loading' && <Spinner></Spinner>}
