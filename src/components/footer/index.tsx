    ...
    <div className="container mx-auto">
      ...
      <div className="grid gap-y-4 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        <div className="sm:col-span-2">
          ...
          <div className="mt-6 lg:mt-9 lg:max-w-sm">
            <p className="text-sm text-gray-500">
              Sàn thương mại điện tử thông minh với chức năng mua bảo hiểm theo
              ngày.
            </p>
            <p className="mt-4 text-sm text-gray-500">
              Với phương thức B2B, FPT Insurance cũng là kênh tích hợp giúp các bạn
              đưa sản phẩm của mình tới người tiêu dùng.
            </p>
          </div>
        </div>
        ...
        <div>
          ...
          <p className="mt-4 text-sm text-gray-500">
            Hãy ghé thăm page FPT Insurance trên Facebook để biết được những thông
            tin mới nhất nhé!
          </p>
        </div>
      </div>
